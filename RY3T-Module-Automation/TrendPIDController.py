...
class ConfigManager:
    ...
    def _log_status(self, status: dict):
        ...
        print(f"[{timestamp}] Primär: {status['primary']['supply_temp']:.1f}°C "
...
class MaxTempDeltaTController:
    ...
    def _check_primary_safety(self, primary_temp: float) -> bool:
        """ENTFERNT - nicht mehr benötigt da normale Sollwertregelung"""
        pass
...
if __name__ == "__main__":
    ...
    # Controller mit Config-Datei initialisieren
    controller = MaxTempDeltaTController(config_file)
    
    # Zeige aktuelle Konfiguration
    print("\nAktuelle Konfiguration:")
    print(f"- Primär Max-Temp: {controller.primary_max_temp}°C")
    print(f"- Sicherheitsabstand: {controller.safety_margin}°C")
    ...
    print("Beispiel: Ändere Primär Max-Temperatur auf 75°C...")
    controller.config_manager.update_parameter('primary_circuit.max_temperature', 75.0)
    controller.reload_config()
    print(f"Neue Max-Temperatur: {controller.primary_max_temp}°C\n")
    ...
    heat_profile = np.concatenate([
        ...
        np.ones(steps//4) * 90,      # Sehr hoch (Test Max-Regelung)
    ...
    # Nach Simulation: Historie exportieren
